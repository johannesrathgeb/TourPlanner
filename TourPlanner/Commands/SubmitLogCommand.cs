...
namespace TourPlanner.Commands
{
    public class SubmitLogCommand : BaseCommand
    {
        ...
        public override void Execute(object? parameter)
        {
            ...
            Tourlog tourlog = TourFactory.GetInstance().AddTourlogToDB(MainWindowVM.SelectedTour.Id, LogsCreationDialogVM.NewLogDate, LogsCreationDialogVM.NewLogComment, LogsCreationDialogVM.NewLogDifficulty + 1, LogsCreationDialogVM.NewLogTotaltime, LogsCreationDialogVM.NewLogRating + 1);
